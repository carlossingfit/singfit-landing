...
export default function CampaignLanding3() {
  ...
  const PANELS = {
    ...
    therapist: {
      ...
      video:
        "https://player.vimeo.com/video/1089881903?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479",
  ...
  return (
    <div className="bg-white min-h-screen px-6 py-8 max-w-6xl mx-auto font-sans text-gray-900">
      ...
      {/* Subtle inline help note (no delay, no animation) */}
      <div className="mt-2 mb-6 text-center text-sm text-gray-700">
        Need help?{" "}
        <a
