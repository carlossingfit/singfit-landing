...
export default function SingFitLandingPage() {
  return (
    <div className="flex flex-col gap-20 px-8 py-16 max-w-7xl mx-auto font-sans text-gray-900 text-base md:text-lg">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start bg-[#EEF6FA] p-10 rounded-xl shadow-xl bg-[url('https://www.transparenttextures.com/patterns/natural-paper.png')] bg-repeat">
        <div className="space-y-6">
          ...
          <div className="flex flex-row gap-4">
            <Button aria-label="Access free therapeutic music resources" className="text-lg px-8 py-4 bg-[#F47534] text-[#FFFFFF] hover:bg-[#d9652c] transition-all duration-200 ease-in-out">
              Get Free Therapeutic Music Resources
            </Button>
        <a href="#what-is-singfit" aria-label="Scroll to What is the SingFit App section">
  <Button className="text-lg px-8 py-4 bg-white border border-[#002F6C] text-[#002F6C] hover:bg-[#eaf2f8]">
    Learn About the App ↓
  </Button>
</a>
        ...
        <motion.div 
          ...
          className="relative w-full h-[300px] overflow-hidden rounded-xl border border-gray-200 shadow-lg"
        >
          <img 
  ...
  <Button aria-label="Download the SingFit App" className="text-xl px-10 py-5 bg-[#F47534] text-white hover:bg-[#d9652c] shadow-lg transition-all duration-200">
    Get the SingFit App
  </Button>
</div>
<p className="text-center text-lg font-bold underline decoration-[#FDD9C7] decoration-1 text-[#002F6C] tracking-wide mb-6">SingFit is Designed For:</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left pt-6">
          <div className="bg-[#FEF8F5] p-6 rounded-lg shadow hover:shadow-lg transition">
            <HeartHandshake className="h-12 w-12 text-[#F47534] mx-auto mb-2" />
<h3 className="font-semibold text-lg">Caregivers & Their Loved Ones</h3>
          ...
          <div className="bg-[#FEF8F5] p-6 rounded-lg shadow hover:shadow-lg transition">
            <BrainCircuit className="h-12 w-12 text-[#F47534] mx-auto mb-2" />
<h3 className="font-semibold text-lg">Older Adults Supporting Brain Health</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 max-w-6xl mx-auto">
          {["Create your profile","Set your goal","Begin your session","Reflect on your session*"].map((title, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.2, duration: 0.5 }} className="space-y-4 hover:scale-105 transition-transform duration-200">
              <img src={`https://static.wixstatic.com/media/264616_${["2389c82006c446cca0f12db06a3d9000","44e07472013845718269c789f125b619","3804aa0322e047aa86b78c4f937e93d8","7696ff978e7e4f8bad929d3739f6043a"][i]}~mv2.png`} alt={`Step ${i + 1}`} className="mx-auto w-24 h-24 object-contain" />
      ...
      <div className="text-center">
        ...
        <p className="text-sm mt-2 text-[#EC1300]">
          Only $8.99/month for AARP Members (30% Discount)
        </p>
      </div>
  ...
  <h3 className="text-lg font-semibold text-black mb-2">Feeling down, anxious, or disconnected</h3>
      ...
      <section className="bg-[#DAECF6] p-10 rounded-xl shadow-md space-y-6 text-center">
