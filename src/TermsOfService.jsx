...
export default function TermsOfService() {
  const htmlString = `
<p><strong>Acceptance of the Terms of Service</strong></p>
<p>​</p>
<p>These Terms of Service are entered into by and between you and SingFit. The following terms and conditions, together with any documents they expressly incorporate by reference (collectively, “Terms of Service”) govern your access to and use of the website located at  (the “Website”) and any related services provided by SingFit, including any content, functionality and services offered on or through the Website.</p>
<p>Please read the Terms of Service carefully before you start to use the Website. <strong>By using the Website or by clicking to accept or agree to the Terms of Service when this option is made available to you, you accept and agree to be bound and abide by these Terms of Service and our <a href="/privacy">Privacy Policy</a>, incorporated herein by reference and to comply with all applicable laws and regulations.</strong> If you do not want to agree to these Terms of Service or the Privacy Policy, you must not access or use the Website and you are prohibited from using any other services provided by SingFit.</p>
<p>​</p>
<p><strong>Changes to the Terms of Service</strong></p>
<p><strong>​​</strong></p>
<p>We, SingFit, reserve the right to review and amend any of these Terms of Service at our sole discretion. Upon doing so, we will update this page. Any changes to these Terms of Service will take effect immediately from the date of publication. All changes are effective immediately when we post them, and apply to all access to and use of the Website thereafter. However, any changes to the dispute resolution provisions set out in “Governing Law and Jurisdiction” will not apply to any disputes for which the parties have actual notice on or before the date the change is posted on the Website.</p>
<p>Your continued use of the Website following the posting of revised Terms of Service means that you accept and agree to the changes. You are expected to check this page each time you access this Website so you are aware of any changes, as they are binding on you.</p>
...
<p>We have the right to disable any username, password, or other identifier, whether chosen by you or provided by us, at any time in our sole discretion for any or no reason, including if, in our opinion, you have violated any provision of these Terms of Service.</p>
<p>​</p>
...
<li>knowingly or negligently use this website or any of its associated services in a way that abuses or disrupts our networks or any other service SingFit provides;</li>
...
<li>use this Website or its associated services in violation of any applicable laws or regulations (including, without limitation, any laws regarding the export of data or software to and from the US or other countries);</li>
...
<p><strong>​</strong></p>
<p>The Website and its entire contents, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof and all intellectual property in the materials contained in the Website) are owned by or licensed to SingFit, its licensors, or other providers of such material and are protected by United States and international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.</p>
<p>These Terms of Service permit you to use the Website for your personal, non-commercial use only. You must not reproduce, distribute, modify, create derivative works of, publicly display, publicly perform, republish, download, store, or transmit any of the material on our Website, except as follows:</p>
<ol>
...
<p>This constitutes the grant of a license, not a transfer of title. This license shall automatically terminate if you violate any of these restrictions or the Terms of Service, and may be terminated by SingFit at any time.</p>
...
<p>If you print, copy, modify, download, or otherwise use or provide any other person with access to any part of the Website in breach of the Terms of Service, your right to use the Website will stop immediately and you must, at our option, return or destroy any copies of the materials you have made. No right, title, or interest in or to the Website or any content on the Website is transferred to you, and all rights not expressly granted are reserved by SingFit. Any use of the Website not expressly permitted by these Terms of Service is a breach of these Terms of Service and may violate copyright, trademark, and other laws.</p>
<p>​​</p>
<p><strong>Trademarks</strong></p>
<p>The SingFit name, the SingFit logo and all related names, logos, product and service names, designs, and slogans are trademarks of SingFit or its affiliates or licensors. You must not use such marks without the prior written permission of SingFit. All other names, logos, product and service names, designs, and slogans on this Website are the trademarks of their respective owners.</p>
<p>​</p>
<p>​</p>
...
<p><strong>​</strong></p>
<p>The materials appearing on our Website are not comprehensive and are for general information purposes only. SingFit does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on this Website, or otherwise relating to such materials or on any resources linked to this Website.</p>
<p><strong>​</strong></p>
...
<p>​</p>
<p>This Website includes content provided by third parties. All statements and/or opinions expressed in these materials, and all articles and responses to questions and other content, other than the content provided by the Company, are solely the opinions and the responsibility of the person or entity providing those materials. These materials do not necessarily reflect the opinion of the Company. We are not responsible, or liable to you or any third party, for the content or accuracy of any materials provided by any third parties. The inclusion of any link does not imply endorsement, approval, or control by SingFit of the site.</p>
<p>​</p>
...
<p>At Company’s sole discretion, it may require you to submit any disputes arising from these Terms of Service or use of the Website, including disputes arising from or concerning their interpretation, violation, invalidity, non-performance, or termination, to final and binding arbitration under the Rules of Arbitration of Judicial Arbitration and Mediation Services (JAMS) applying California law.</p>
<p>​</p>
...
<p>The Terms of Service and our Privacy Policy constitute the sole and entire agreement between you and SingFit regarding the Website and supersede all prior and contemporaneous understandings, agreements, representations, and warranties, both written and oral, regarding the Website.</p>
<p><strong>Your Comments and Concerns</strong></p>
<p>All other feedback, comments, requests for technical support, and other communications relating to the Website should be directed to: <a href="mailto:support@singfit.com">support@singfit.com</a>.</p>
<p><strong>​</strong></p>`;
  return (
    <LegalLayout>
