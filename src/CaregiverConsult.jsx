...
export default function CaregiverConsult() {
...
.uniform-benefit-image{
  min-height:0;
  aspect-ratio:4 / 3;
}

.benefit-row .uniform-benefit-image img{
  min-height:0;
...
>
  ...
  <strong>Free 20-minute walkthrough</strong>
  <span>Talk with the SingFit team. No obligation.</span>
</div>
            </aside>
          </header>
              ...
              <div className="hero-stage">
                <div className="hero-image-panel">
                  <div className="hero-image-art hero-photo-art">
                    <img
  src="/Fixed Laina Testimonial Image.png"
  alt="Two women smiling at each other beside a tablet during a SingFit session"
  fetchPriority="high"
  decoding="async"
/>
                  </div>
          ...
          <section className="section who-redesign" id="who">
            <div className="who-situation-layout">
              ...
              <div className="who-situation-list">
                <div className="who-situation">
                  <span>01</span>
                  <div>
                    <h3>Dementia, memory loss, or cognitive decline</h3>
                    <p>
                      Use familiar songs when words, attention, or conversation feel
                      harder to reach.
                    </p>
                  </div>
                </div>
            ...
            <div className="section-cta section-cta-left who-section-cta">
              ...
              <p className="section-cta-note">
                See how the app works, ask questions, and decide whether SingFit is a
                good fit for you.
              </p>
            </div>
          </section>
  ...
  <div className="benefits-intro-row">
    <div className="benefits-intro-copy">
      <h2>
        Designed to encourage engagement and meaningful connection through
        singing together.
      </h2>
      ...
      <div className="product-phone product-phone-intro">
        <div className="product-phone-screen">
          <video
            ...
            preload="none"
            disablePictureInPicture
            aria-label="Preview of a guided SingFit STUDIO Caregiver session"
          >
  ...
  <div className="benefit-editorial">
    <article className="benefit-row">
      <div className="benefit-image benefit-real-image uniform-benefit-image">
        <img
          src="/Sandy-Tubman-and-Caregiver-Picture-Light-Blue-Background.jpeg"
      ...
      <div className="benefit-copy">
        <h3>Singing can create a brighter moment</h3>
        <p>
          Singing familiar songs together can provide a shared activity during
          a routine, visit, or difficult moment.
        </p>
      </div>
    </article>
    ...
    <article className="benefit-row">
      ...
      <div className="benefit-copy">
        <h3>Familiar songs may encourage reminiscence and conversation</h3>
        <p>
          Singing familiar lyrics may encourage recognition, reminiscence, and
          conversation.
        </p>
      </div>
    </article>
    ...
    <article className="benefit-row">
      <div className="benefit-image benefit-real-image uniform-benefit-image">
        <img
          src="/Alicia-and-woman-pink-shirt-sing-clean.jpeg"
  ...
  <p className="section-cta-note">
    Free 20-minute conversation with the SingFit team to walk through the app.
  </p>
</div>
          </section>
          ...
          <section className="section center" id="questions">
            ...
            <div className="faq">
              {[
                ...
                ["What happens after I schedule a walkthrough?", "You’ll have a complimentary 20-minute conversation with the SingFit team to ask questions and see if the app is a good fit for you. There is no obligation to purchase the app."],
  ...
  <div className="final-copy">
    <h2>Let's see if SingFit is right for you.</h2>

    <p className="lead">
      Every family is different. Schedule a free walkthrough to see how STUDIO Caregiver works, ask questions, and decide whether it's right for you.
    </p>

    <div className="proof-line">
      <span>Guided singing walkthrough</span>
  ...
  <div className="price-card">
    <div className="price-top">
      <small>FREE WALKTHROUGH</small>

      <div className="price-inline">
        <strong>20-minute</strong>
      </div>

      <p className="price-sub">app demo</p>
    </div>
  ...
  <div>
    ...
    <p className="section-cta-note">
      No obligation. Just a chance to see whether SingFit is right for you.
    </p>
  </div>
</section>
...
>
  ...
  >
    SingFit STUDIO Caregiver is designed to support engagement and shared
    musical experiences. It does not provide medical, therapeutic, or
    caregiving advice and is not intended to diagnose, treat, cure, or prevent
  ...
  <p className="footer-cta-note">
    Talk with the SingFit team. No obligation.
  </p>
</div>
          </footer>
        </div>
