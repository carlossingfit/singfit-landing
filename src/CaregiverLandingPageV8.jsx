...
export default function CaregiverLandingPageV8() {
  ...
  const testimonials = [
    ...
    {
      quote:
        "During our first SingFit session, she sang 15 songs. She's really enjoying this.",
      name: "Gabriella",
      role: "Family caregiver",
    },
    {
      quote:
        "He will say, 'I think I'm coming back.' He's feeling more like himself. And I think this is really good.",
      name: "Jan",
      role: "Family caregiver",
    },
  ];
    ...
    <main className="min-h-screen overflow-hidden bg-[#F7F9FC] text-[#062B49] antialiased">
      ...
      <section className="relative px-5 pb-14 pt-8 md:px-10 md:pb-20 md:pt-12">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.03fr_0.97fr]">
          <div>
            ...
            <h1 className="max-w-5xl text-[3.2rem] font-black leading-[0.94] tracking-[-0.075em] md:text-[5.7rem] lg:text-[6.8rem]">
            ...
            <p className="mt-8 max-w-2xl text-xl leading-relaxed text-slate-700 md:text-2xl">
                ...
                session, press play, follow the lyric cues, and share familiar songs together
                from your phone.
            </p>
            ...
            <div className="mt-8 grid max-w-xl gap-3 sm:grid-cols-3">
              {["Subscribe here", "Download the app", "Sign in and start"].map(
                (item) => (
                  <div
                    key={item}
      ...
      <section className="px-5 py-10 md:px-10 md:py-14">
        <div className="mx-auto grid max-w-7xl items-stretch gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="relative overflow-hidden rounded-[3rem] bg-white shadow-[0_34px_90px_rgba(15,23,42,0.10)]">
            <img
              src="/laina_anita.PNG"
              alt="Caregiver sharing a music moment"
      ...
      <section className="px-5 py-10 md:px-10 md:py-14">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-px overflow-hidden rounded-[2.75rem] border border-slate-200 bg-slate-200 shadow-[0_34px_90px_rgba(15,23,42,0.09)] md:grid-cols-3">
            {[
              {
              ...
              },
              {
                ...
                text: "Start during quiet time, a visit, a routine, or one difficult part of the day.",
              },
            ].map((item) => (
        ...
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[3.25rem] bg-[#061D33] shadow-[0_44px_120px_rgba(6,29,51,0.32)]">
          <div className="relative px-6 py-14 text-center text-white md:px-16 md:py-20">
            ...
            <div className="relative">
              ...
              <h2 className="mx-auto max-w-6xl text-5xl font-black leading-[0.94] tracking-[-0.075em] md:text-8xl">
